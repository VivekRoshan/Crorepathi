...
public class OptionA extends JPanel{
    ...
    public OptionA() {
    	...
    	addMouseListener(optionalistener);
    	
    }
    
    MouseListener optionalistener=new MouseListener(){
